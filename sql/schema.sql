...
insert into auth_user values(1,'tangsi','tangside163@163.com','123','18670950325','柔软时光',0,0);
insert into auth_role values(1,'超级管理员','超级管理员角色');
insert into auth_permission values(1,'超级权限','这个是超级权限');
