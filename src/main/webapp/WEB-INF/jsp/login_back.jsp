...
<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			var $form_inputs =   $('form input');
			  ...
			  $form_inputs.click(function(){
				  $(this).next("span").html("");  //清空tips提示
			  });
		...
		<div class="rain">
			<div class="border start">
				<form action="${base}/user/login" method="post">
					...
					<input name="username" type="text" placeholder="用户名"/><span>${usernameMsg}</span>
					<label for="password">密码</label>
					<input name="password" type="password" placeholder="密码"/> <span>${pwdMsg}</span>
